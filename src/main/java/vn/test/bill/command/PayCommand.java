...
public class PayCommand extends AbstractBillCommand implements BillCommand {

	public PayCommand(Accounts account) {
		super(account);
	}
	...
	public CommandResponse execute(CommandArgument arg) throws IllegalArgumentException {
		...
		return CommandResponse.ok(new PayCommandResponseData(notfoundBillNoList, outOfFundBillNoList, account.getFund()));
	}
