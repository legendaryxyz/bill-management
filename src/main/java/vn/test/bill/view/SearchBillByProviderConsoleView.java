...
public class SearchBillByProviderConsoleView implements BillConsoleView {
	...
	public void view(CommandResponse response) {
		...
		SearchBillByProviderCommandResponseData data = (SearchBillByProviderCommandResponseData) response.getData();
		viewHeader();
